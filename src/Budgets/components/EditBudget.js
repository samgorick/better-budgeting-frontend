...
class EditBudget extends React.Component {
  ...
  componentDidMount() {
    // Set bills as default to prevent appearing blank to the user
  ...
  remaining = () => {
    ...
    const income = this.props.budget.find(budg => budg.spending_category === 'Income');
    const spendingBudget = this.props.budget.filter(cat => cat.spending_category !== 'Income');
  ...
  updateBudget = () => {
    // convert amount back into numeric value
    ...
    return (
      <KeyboardAwareScrollView contentContainerStyle={{...styles.container}}>
        <View style={{...styles.container, justifyContent: 'center'}}>
          ...
          <TouchableOpacity style={styles.buttonContainer} onPress={this.updateBudget}>
